(function(){
  ...
  css.textContent=
    ...
    '.suite-nav-inner{max-width:720px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;height:52px;}'+
    ...
    '.suite-nav-link{font-size:13px;font-weight:500;color:#999;text-decoration:none;padding:6px 12px;border-radius:100px;transition:all 0.2s;white-space:nowrap;}'+
    ...
    '.suite-nav-mobile a{display:block;font-size:14px;font-weight:500;color:#666;text-decoration:none;padding:12px 0;border-bottom:1px solid #f0f0f0;}'+
    ...
    '@media(max-width:700px){.suite-nav-links{display:none;}.suite-nav-hamburger{display:block;}}';
  ...
  for(var i=0;i<items.length;i++){
    ...
    linksHTML+='<a href="'+it.href+'" class="suite-nav-link'+(isActive?' active':'')+'">'+it.label+'</a>';
    mobileHTML+='<a href="'+it.href+'"'+(isActive?' class="active"':'')+'>'+it.label+'</a>';
  }
